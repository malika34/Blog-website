...
// Mock account names
const accountNames = ["Ali", "Sarah", "Ameen", "Daniyal", "Hamza"];
...
const Comments: React.FC = () => {
  ...
  return (
    <div className="p-6 bg-gray-50 dark:bg-black rounded-md shadow-md max-w-3xl mt-8 mx-auto">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <input
          ...
          className="flex-1 border border-gray-300 p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white"
        />
        {/* Submit Button */}
        <Button
          onClick={addComment}
          className="bg-black dark:bg-gray-700 dark:hover:bg-slate-800 text-white font-semibold py-2 px-4 rounded-lg"
        >
          Submit
        </Button>
      </div>
      ...
      <ul className="space-y-4">
        {comments.map((comment, index) => (
          <li
            key={index}
            className="flex items-start gap-4 p-4 bg-white dark:bg-gray-900 shadow-sm rounded-lg"
          >
            {/* Avatar */}
            <div
